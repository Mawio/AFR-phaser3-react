...
function RaceTag() {
    ...
    return (
        <div className="race-interface-box" style={
            { color: "#073763", display: "flex", alignItems: "center", flexDirection: "row", marginTop: "23px", height: "46px", width: "fit-content", position: "absolute", left: "50%", transform: "translateX(-50%)" }
        }>
